...
- `workspace.yaml` is the root runtime plan for the workspace. It defines the single active agent, skill enablement or order, MCP registry, and any installed workspace apps.
