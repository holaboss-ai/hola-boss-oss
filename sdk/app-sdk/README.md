...
Generated TypeScript client for the Holaboss product API. Consumed by the Holaboss web app and the open-source [Holaboss Desktop](https://github.com/holaboss-ai/holaboss-ai) (hola-boss-oss).
