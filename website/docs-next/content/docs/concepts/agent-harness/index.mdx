...
<Cards>
  <Card title="Adapter Capabilities" href="/docs/concepts/agent-harness/adapter-capabilities" description="Start with the runtime adapter contract, then move through the detailed capability pages." />
  <Card title="Agent Harness Internals" href="/docs/contribute/agent-harness/internals" description="Inspect the code seams that matter if you want to expand or replace the current harness path." />
</Cards>
